...
class Mobility:
    ...
    def __init__(self, activity_data, reduction_data):
        """
        ...
        reduction_data: Triplet (N, LV, LF) as returned by contacts.load_period_activities().
            - N is the pair of integers (number of agents, number of facilities).
            - LF is the list of locations of all agents during each period.
            - LT is the list of activity types of all activities during each period.
        ...
        # Same thing for the reduction data
        ...
        self.original_locations_reduction = self.locations_reduction.copy()
    ...
    def reset(self, reduction = False):
        """
        ...
        if reduction :
            ...
            for period in range(self.n_periods):
                ...
                self.locations_reduction[period] = self.original_locations_reduction[period].copy()
    ...
    def get_infected_visitors(self, period, reduction = False):
        """
        Parameters
        ----------
        period: int, which time period to consider.
    ...
    def get_locations(self, period=None, reduction = False):
        """
        Parameters
        ----------
        ...
        reduction: boolean, optional. If specified, returns the locations during the restriction period instead.
        Returns
        -------
        ...
        if reduction:
            if period is None:
                return self.locations_reduction
            else:
                return self.locations_reduction[period]
        else :   
            if period is None:
